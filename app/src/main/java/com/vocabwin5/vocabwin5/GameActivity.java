...
public class GameActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE = "com.vocabwin5.vocabwin5." + TAG;
    public static final String EXTRA_MESSAGE_2 = "com.vocabwin5.vocabwin5." + TAG + ".max";
    ...
    private void setNewText() {
        try {
            ...
            String url = "https://vocabwin.herokuapp.com/falseChoices5?word=" + answerWithoutSpacesAndSharpS + "&lang=" + language + "&speech=" + speech;
